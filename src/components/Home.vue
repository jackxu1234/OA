	...
	<el-container class="home-container">
		...
		<el-header>
			<div style="white-space:nowrap;margin-left: 15px;">
				...
				<div class=""><i class="el-icon-user">管理员</i></div>
			</div>
				...
				<el-col :span="30">
					<el-menu default-active="1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose"
						...
						<el-submenu index="2" style="margin-left: 20px">
							<span slot="title"><i class="el-icon-s-custom"></i>员工管理</span>
							<el-menu-item-group>
								<el-menu-item index="1-1" @click="addEmp"><i class="el-icon-plus"></i>添加员工
								</el-menu-item>
								<el-menu-item index="1-2" @click="delEmp"><i class="el-icon-delete"></i>删除员工
								</el-menu-item>
								<el-menu-item index="1-3" @click="queryEmp"><i class="el-icon-setting"></i>信息管理
								</el-menu-item>
							</el-menu-item-group>
						</el-submenu>

						<el-submenu index="3">
							<span slot="title"><i class="el-icon-discount"></i>部门管理</span>
							<el-menu-item-group>
								<el-menu-item index="2-1" @click="addDept"><i class="el-icon-plus"></i>添加部门
								</el-menu-item>
								<el-menu-item index="2-2" @click="delDept"><i class="el-icon-delete"></i>删除部门
								</el-menu-item>
								<el-menu-item index="2-3" @click="queryDept"><i class="el-icon-setting"></i>部门编辑
								</el-menu-item>
								<!-- <el-menu-item index="2-4">修改</el-menu-item> -->
							</el-menu-item-group>
						</el-submenu>

						<el-submenu index="4">
							<span slot="title"><i class="el-icon-s-opportunity"></i>公告管理</span>
							<el-menu-item index="3-1" @click="toNoticePage"><i class="el-icon-s-data"></i>公告设置
							</el-menu-item>
							<el-menu-item index="3-2" @click="toNoticeAdd"><i class="el-icon-plus"></i>添加公告
							</el-menu-item>
						</el-submenu>

						<el-submenu index="5">
							<span slot="title"><i class="el-icon-s-order"></i>请假管理</span>
							<el-menu-item index="4-1" @click="toLeavePage"><i class="el-icon-s-check"></i>请假单审批
							</el-menu-item>
							<!-- <el-menu-item index="4-2" @click="addLeave"><i class="el-icon-s-promotion"></i>填写请假单
							</el-menu-item> -->
						</el-submenu>

						<el-submenu index="6">
							<span slot="title"><i class="el-icon-date"></i>考勤管理</span>
							<el-menu-item index="5-1" @click="toAtedPage"><i class="el-icon-thumb"></i>展示全部考勤信息
							</el-menu-item>
						</el-submenu>
					</el-menu>
				</el-col>
...
<script>
	...
	export default {
		...
		methods: {
			...
			toAtedPage() {
				this.$router.push('/atted/queryAttend')
			},
			dateFormat(time) {
